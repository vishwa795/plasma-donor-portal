...
/* Mutations */
export const ADD_USER_INFO = gql`mutation AddUserInfo($_eq: String = "", $blood_group: String = "", $district: String = "", $phone: String = "", $pin_code: String = "", $recovered_on: date , $social_link: String = "", $social_type: String = "", $state: String = "") {
