...
/* Mutations */
export const ADD_USER_INFO = gql`mutation AddUserInfo($_eq: String = "", $blood_group: String = "", $district: String = "", $phone: String = "", $pin_code: String = "", $recovered_on: timestamptz = "", $social_link: String = "", $social_type: String = "", $state: String = "") {
  update_users(where: {user_id: {_eq: $_eq}}, _set: {blood_group: $blood_group, district: $district, phone: $phone, pin_code: $pin_code, recovered_on: $recovered_on, social_link: $social_link, social_type: $social_type, state: $state, status: "true"}) {
    affected_rows
  }
}`
